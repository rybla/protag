...
choice :: forall m a @opts. Applicative m => Homogeneous opts Unit => PlainHTML -> Proxy opts -> (Variant opts -> PlainHTML) -> (Variant opts -> a) -> InstructionT m a
...
type ExistsChoiceK m (a :: Type) r = forall opts. Homogeneous opts Unit => Proxy opts -> (Variant opts -> PlainHTML) -> (Variant opts -> m a) -> r
...
mkExistsChoice :: forall m a opts. Homogeneous opts Unit => Proxy opts -> (Variant opts -> PlainHTML) -> (Variant opts -> m a) -> ExistsChoice m a
